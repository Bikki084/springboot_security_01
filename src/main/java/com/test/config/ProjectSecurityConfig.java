...
import com.test.filter.AuthoritiesLoggingAfterFilter;
import com.test.filter.AuthoritiesLoggingAtFilter;
import com.test.filter.JWTTokenGeneratorFilter;
import com.test.filter.JWTTokenValidatorFilter;
import com.test.filter.RequestValidationBeforeFilter;
